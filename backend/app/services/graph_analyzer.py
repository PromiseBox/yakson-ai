...
def analyze_medications_with_graph(payload: AnalyzeRequest, db: Session) -> AnalysisReport:
    ...
    return AnalysisReport(
        ...
        caregiverDetailText=report_texts.caregiver_detail,
        pharmacistDetailText=report_texts.pharmacist_detail,
        recommendedQuestions=report_texts.recommended_questions,
        alertExplanations=report_texts.alert_explanations,
